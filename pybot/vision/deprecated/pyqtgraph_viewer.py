...
class PyQtGraphViewer: 
    def __init__(self): 
        ...
        color = (np.random.rand(100, 4) + 1) * 0.5
        ...
        self.sp1 = gl.GLScatterPlotItem(pos=pos, size=size, color=color, pxMode=False)
        self.sp1.translate(5,5,0)
        self.win.addItem(self.sp1)
    ...
    def create_window(self):
        ...
        if self.app is None:
            ...
            app_created = True
            print 'Creating Qt Aplication Instance'
        else: 
            print 'Using existing Qt Application Instance'
