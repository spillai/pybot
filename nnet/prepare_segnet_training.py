...
if __name__ == "__main__":
    ...
    for f in files: 
        target_f = f.replace('raw.png', 'classified.png')
    ...
    write_data(args.filename + '_train.txt', train_image_files, train_target_files)
    write_data(args.filename + '_test.txt', test_image_files, test_target_files)
