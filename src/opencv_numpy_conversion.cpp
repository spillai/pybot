...
void export_converters(void) {
  ...
  expose_template_type< std::vector<cv::Vec2i> >();
  expose_template_type< std::vector<cv::Vec3i> >();
  ...
  py::to_python_converter<cv::Vec2i, Mat_to_PyObject<cv::Vec2i> >();
  py::to_python_converter<cv::Vec3i, Mat_to_PyObject<cv::Vec3i> >();
